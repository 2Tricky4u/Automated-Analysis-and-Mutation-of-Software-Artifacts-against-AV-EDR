...
BASELINE_RESPONSE=$(grpcurl -plaintext localhost:50051 \
  -d '{
    "template_name": "loader_v1",
...
MUTATED_RESPONSE=$(grpcurl -plaintext localhost:50051 \
  -d '{
    "template_name": "loader_v1",
    "source_file": "loader_v1.c",
    "mutations": [
...
MULTI_RESPONSE=$(grpcurl -plaintext localhost:50051 \
  -d '{
    "template_name": "loader_v1",
    "source_file": "loader_v1.c",
    "mutations": [
